...
parser.add_argument('--model', type=str,
                    default='TDM_contrastive_UNet', help='model_name')
...
#     writer = SummaryWriter(snapshot_path + '/log')
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs1, positive_feature1, negative_feature1 = model1(volume_batch,tdm,istrain=True,ismlp=ismlp)
            outputs_soft1 = torch.softmax(outputs1, dim=1)
            outputs_soft1 = outputs_soft1*tdm

          
            #version_1
            outputs2, positive_feature2, negative_feature2 = model2(volume_batch,tdm,istrain=True,ismlp=ismlp) 
            outputs_soft2 = torch.softmax(outputs2, dim=1)
            outputs_soft2 = outputs_soft2*tdm
...
#             outputs_soft2 = outputs_soft2
            ...
            contrastive_loss1_p = contrastive_loss(positive_feature1, positive_feature2, negative_feature2, label='pos')
            contrastive_loss1_n = contrastive_loss(negative_feature1, negative_feature2, positive_feature2, label='neg')
            contrastive_loss2_p = contrastive_loss(positive_feature2, positive_feature1, negative_feature1, label='pos')
            contrastive_loss2_n = contrastive_loss(negative_feature2, negative_feature1, positive_feature1, label='neg')
...
#             print('contrastive_loss2_n:',contrastive_loss2_n)
            ...
            loss = model1_loss + model2_loss + final_contrastive_loss
