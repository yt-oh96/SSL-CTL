...
parser.add_argument('--exp', type=str,
                    default='UFMR_DCMR/Cross_Consistency_Training', help='experiment_name')
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num % 20 == 0:
                ...
                sitk.WriteImage(source, os.path.join('./cross_consistency', '{}_image.nii.gz'.format(iter_num)))
        
                o = sitk.GetImageFromArray(outputs.data.cpu().float())
                sitk.WriteImage(o, os.path.join('./cross_consistency', '{}_o.nii.gz'.format(iter_num)))
                
                l = sitk.GetImageFromArray(labs.data.cpu())
                sitk.WriteImage(l, os.path.join('./cross_consistency', '{}_l.nii.gz'.format(iter_num)))
...
if __name__ == "__main__":
    ...
    wandb.init(project='SSL_UFMR_DCMR_cross_consistency')
